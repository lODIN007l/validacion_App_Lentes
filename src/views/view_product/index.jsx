        ...
        <div className="product-view">
          ...
          <div className="product-modal">
            ...
            <div className="product-modal-details">
              ...
              <br />
              <div>
                <span className="text-subtle">Seleccionar la talla </span>
                <br />
                <br />
                <Select
              ...
              {product.availableColors.length >= 1 && (
                <div>
                  <span className="text-subtle">Escoger Color</span>
                  <br />
                  <br />
                  <ColorChooser
              ...
              <div className="product-modal-action">
                <button
                  ...
                  type="button"
                >
                  {isItemOnBasket(product.id) ? 'Eliminar del carrito' : 'Agregar al carrito'}
                </button>
              </div>
            </div>
          </div>
